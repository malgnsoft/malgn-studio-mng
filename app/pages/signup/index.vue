...
const privacyText = '맑은스튜디오 프로젝트 관리 사이트는 회원 식별 및 프로젝트 참여자 관리를 위해 아이디·성명·회사명·역할·이메일·휴대전화번호를 수집·이용합니다. 수집 항목은 회원 탈퇴 시까지 보관하며, 법령에 따른 경우를 제외하고 제3자에게 제공하지 않습니다. (상세 처리방침은 추후 확정)'
