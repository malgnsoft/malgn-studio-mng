...
export const wbsGantt: GanttItem[] = [
  ...
  // ── Step 2 · 기획 ─────────────────────────────────────
  { step: 2, group: '서비스 기획', name: '서비스 개요·비전 (00)', owner: 'planner', start: '2026-06-17', end: '2026-06-17', progress: 100 },
  { step: 2, group: '서비스 기획', name: '차별화 전략 (02)', owner: 'planner', start: '2026-06-17', end: '2026-06-17', progress: 100 },
  { step: 2, group: '서비스 기획', name: '기능 정의·범위 MVP 매트릭스 (03)', owner: 'planner', start: '2026-06-17', end: '2026-06-17', progress: 100 },
  ...
  { step: 2, group: '로드맵·NFR', name: '비기능 요구 NFR (12)', owner: 'planner', start: '2026-06-17', end: '2026-06-17', progress: 100 },
